...
public class Language {
    ...
    private final String[] GERMAN={"Start", "Info","Mitwirkende","MARVIN UND SEINE FREUNDE","SO WIRD GESPIELT","Es geht eigentlich nur darum, dass du dich ein bisschen mit der Schule beschäftigst." +
    ...
    private final String[] ENGLISH={"Start", "Info","Credits","MARVIN AND HIS FRIENDS","HOW TO PLAY","It's basically just about you getting in touch with the school. It means: After you clicked on \"Start\", you " +
            "should only answer 10 little questions. In case you can't answer a question on your own, you can do these things: go to the rooms, ask students, use a hint (but you only have 2!) or" +
